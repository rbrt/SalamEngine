...
void Renderer::createSemaphores() 
{
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) 
    {
        ...
        {
            cout << "Created synchronization semaphores for frame " << i << endl;
        }
    }
...
void Renderer::createCommandBuffers()
{
    ...
    for (size_t i = 0; i < commandBuffers.size(); i++) 
    {
        ...
        {
            cout << "Begin recording command buffer " << i << " of total: " << commandBuffers.size() <<  endl;
        }
        ...
        {
            cout << "Recorded command buffer" << endl;
        }
    }
}
...
void Renderer::createImageViews() 
{
    ...
    for (size_t i = 0; i < swapChainImages.size(); i++) 
    {
        ...
        {
           cout << "Created image view at index: " << i << " of total: " << swapChainImages.size() << endl;
        }
    }
}
...
{
    auto vertShaderCode = readFile("D:/Projects/SalamEngine/SalamEngine/SalamEngine/Shaders/vert.spv");
    auto fragShaderCode = readFile("D:/Projects/SalamEngine/SalamEngine/SalamEngine/Shaders/frag.spv");
    ...
    {
        cout << "Created graphics pipeline layout" << endl;
    }
    ...
    {
        cout << "Created graphics pipeline object" << endl;
    }
...
VkShaderModule Renderer::createShaderModule(const std::vector<char>& code) 
{
    ...
    {
        cout << "Created vertex and fragment shaders" << endl;
    }
...
VkExtent2D Renderer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) 
{
    ...
    {
        VkExtent2D actualExtent = { Renderer::WINDOW_WIDTH, Renderer::WINDOW_HEIGHT };
